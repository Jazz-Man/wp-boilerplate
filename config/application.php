 ...
 * Custom Settings.
 */
Config::define( 'WP_MAIL_SMTP_HOST', env( 'WP_MAIL_SMTP_HOST' ) ?: false );
Config::define( 'WP_MAIL_SMTP_PORT', env( 'WP_MAIL_SMTP_PORT' ) ?: false );
Config::define( 'WP_MAIL_SMTP_SECURE', env( 'WP_MAIL_SMTP_SECURE' ) ?: 'ssl' );
Config::define( 'WP_MAIL_SMTP_USERNAME', env( 'WP_MAIL_SMTP_USERNAME' ) ?: false );
Config::define( 'WP_MAIL_SMTP_PASSWORD', env( 'WP_MAIL_SMTP_PASSWORD' ) ?: false );

Config::define( 'WPCF7_RECAPTCHA_SITEKEY', env( 'WPCF7_RECAPTCHA_SITEKEY' ) ?: false );
Config::define( 'WPCF7_RECAPTCHA_SECRET', env( 'WPCF7_RECAPTCHA_SECRET' ) ?: false );
...
// Disable Autosave - DAY_IN_SECONDS
...
$current_server = parse_url( Config::get( 'WP_HOME' ) );
 ...
 */
$proto = app_get_server_data( 'HTTP_X_FORWARDED_PROTO', FILTER_VALIDATE_REGEXP, [
    'options' => [
        'regexp' => '/https/i',
    ],
] );
 ...
 */
$server_host = app_get_server_data( 'HTTP_HOST', FILTER_VALIDATE_DOMAIN, FILTER_FLAG_HOSTNAME );
